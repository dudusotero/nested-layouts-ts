...
const ActiveLink: FC<{ href: string; className?: string }> = ({
  children,
  href,
  className
}) => {
  ...
  return (
    <Link href={href} scroll={false}>
      <a
        ...
        } ${className} block pb-4 font-semibold text-sm sm:text-base border-b-2 focus:outline-none focus:text-gray-900 whitespace-nowrap`}
      >
        {children}
      </a>
    </Link>
...
const AccountSettingsLayout: FC = ({ children }) => {
  return (
